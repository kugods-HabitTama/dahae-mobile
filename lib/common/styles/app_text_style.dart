...
abstract class AppTextStyle {
  ...
  static TextStyle commonItemDescriptionStyle =
      AppTextStyle.mediumStyle.copyWith(
    fontSize: 12.0,
    color: AppColors.middleGrey,
  );
  ...
  static TextStyle leaderboardKmTextStyle =
      AppTextStyle.leaderboardTextStyle.copyWith(
    color: AppColors.black,
  );

  static TextStyle leaderboardLeaderTextStyle =
      AppTextStyle.leaderboardTextStyle.copyWith(
    color: AppColors.black,
  );

  static TextStyle leaderboardLocalUserTextStyle =
      AppTextStyle.leaderboardTextStyle.copyWith(
    color: AppColors.black,
  );
